...
* Объявление переменных
	...
	И Я запоминаю в переменную "111" значение 0
...
Сценарий: <08>. Возврат товара частичный в текущей смене - Наличные
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
* Корректировка возвратного чека
	И в таблице "Товары" я перехожу к строке:
		| 'Количество' | 'Номенклатура'                            | 'Сумма'  | 'Характеристика'                   | 'Цена'   |
		| '1,000'      | 'Штучный товар без характеристик без НДС' | '100,00' | '<характеристики не используются>' | '100,00' |
...
Сценарий: <15>. Возврат товара полный в текущей смене - Безнал
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <16>. Возврат товара полный в текущей смене - Смешанная оплата
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <09>. Оформление чека для возврата вне смены - Оплата наличными
* Закрытие онок клиентского приложения	
	И Я закрываю все окна клиентского приложения
...
Сценарий: <10>. Оформление чека с ручной скидкой для возврата вне смены- Оплата наличными
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <11>. Оформление чека с ручной скидкой для возврата вне смены- Безналичная оплата
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <14>. Оформление чека для возврата вне смены - Оплата безналом
...
Сценарий: <12>. Z - отчет. Проверка закрытия кассовой смены
* Закрытие онок клиентского приложения	
	И Я закрываю все окна клиентского приложения
...
Сценарий: <13>. Открытие кассовой смены
* Открытие смены
	И Я закрываю все окна клиентского приложения
	Тогда я активизирую окно 'РМК: Арида(ptr-46): РМК (управляемый режим)'
	И я нажимаю на гиперссылку с именем "ДекорацияОткрытиеСмены"

Сценарий: <17>. Возврат товара полный в закрытой смене - Наличные
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <18>. Возврат товара полный в закрытой смене - Безнал
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <19>. Х - отчет. Сменный отчет без гашения
* Закрытие онок клиентского приложения	
	Если предыдущий сценарий выполнен успешно Тогда
	иначе
		И Я закрываю все окна клиентского приложения
...
Сценарий: <20>. Z - отчет. Проверка закрытия кассовой смены
* Закрытие онок клиентского приложения	
	И Я закрываю все окна клиентского приложения
